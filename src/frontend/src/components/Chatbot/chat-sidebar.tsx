              ...
              convs.length > 0 && (
                <div key={period} className="mb-6">
                  <div className="mb-3 flex items-center gap-3 px-3 py-2">
                    ...
                    <span className="text-muted-foreground from-ow-aqua to-ow-purple bg-gradient-to-r bg-clip-text text-xs font-bold uppercase tracking-wider text-transparent">
                      {period}
                    </span>
                  </div>
