...
export default function OverworkedLanding() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDark ? "dark bg-[#181818]" : "bg-[#fffffe]"}`}>
      {/* Navbar */}
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${isDark ? "bg-[#181818]/90" : "bg-[#fffffe]/90"} backdrop-blur-md border-b ${isDark ? "border-[#4fc4cf]/20" : "border-[#994ff3]/20"}`}
      >
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span
                className={`text-2xl font-bold bg-gradient-to-r from-[#4fc4cf] to-[#994ff3] bg-clip-text text-transparent`}
              >
                Overworked
              </span>
            </motion.div>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            <motion.h1
              className={`text-5xl md:text-7xl font-bold mb-6 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.p
              className={`text-xl md:text-2xl mb-8 ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        >
          <ChevronDown className={`h-8 w-8 ${isDark ? "text-[#fffffe]/60" : "text-[#181818]/60"}`} />
        </motion.div>
      </section>

      {/* About Section */}
      <section id="about" className={`py-20 ${isDark ? "bg-[#181818]" : "bg-[#fffffe]"}`}>
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
              About{" "}
              <span className="bg-gradient-to-r from-[#4fc4cf] to-[#994ff3] bg-clip-text text-transparent">
                Overworked
              </span>
            </h2>
            <p className={`text-xl max-w-3xl mx-auto ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <Card
                  className={`h-full ${isDark ? "bg-[#181818] border-[#4fc4cf]/20" : "bg-[#fffffe] border-[#994ff3]/20"} hover:border-[#4fc4cf] transition-colors`}
                >
                  <CardContent className="p-8 text-center">
                    ...
                    <h3 className={`text-xl font-bold mb-4 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                      {item.title}
                    </h3>
                    <p className={`${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>{item.description}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
            ...
            {[
              ...
              >
                <div className="flex-1">
                  <div
                    className={`p-8 rounded-2xl ${isDark ? "bg-[#181818]/50" : "bg-[#fffffe]/50"} backdrop-blur-sm border ${isDark ? "border-[#4fc4cf]/20" : "border-[#994ff3]/20"}`}
                  >
                    <div className="flex items-center mb-4">
                      <span className="text-6xl font-bold bg-gradient-to-r from-[#4fc4cf] to-[#994ff3] bg-clip-text text-transparent mr-6">
                        {item.step}
                      </span>
                      <h3 className={`text-2xl font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                        {item.title}
                      </h3>
                    </div>
                    <p className={`text-lg ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>
                      {item.description}
                    </p>
                  </div>
                </div>
      ...
      {/* Features Section */}
      <section id="features" className={`py-20 ${isDark ? "bg-[#181818]" : "bg-[#fffffe]"}`}>
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <Card
                  className={`h-full ${isDark ? "bg-[#181818] border-[#4fc4cf]/20" : "bg-[#fffffe] border-[#994ff3]/20"} hover:border-[#4fc4cf] transition-all duration-300 hover:transform hover:scale-105`}
                >
                  <CardContent className="p-6">
                    ...
                    <h3 className={`text-xl font-bold mb-3 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                      {feature.title}
                    </h3>
                    <p className={`${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>{feature.description}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className={`text-xl font-bold mb-2 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                        {item.title}
                      </h3>
                      <p className={`${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>{item.description}</p>
                    </div>
            ...
            >
              ...
              >
                <div className="text-center">
                  ...
                  <h3 className={`text-2xl font-bold mb-4 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                    Join the Revolution
                  </h3>
                  <p className={`text-lg mb-6 ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>
      ...
      {/* Marquee Section */}
      <section className={`py-12 overflow-hidden ${isDark ? "bg-[#181818]" : "bg-[#fffffe]"}`}>
      ...
      >
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className={`text-xl max-w-3xl mx-auto mb-8 ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <Card
                className={`${isDark ? "bg-[#181818]/50 border-[#4fc4cf]/20" : "bg-[#fffffe]/50 border-[#994ff3]/20"} backdrop-blur-sm`}
              >
                <CardContent className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <h3 className={`text-3xl font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>CRY Token</h3>
                  </div>

                  <div className="space-y-6">
                    <div className="flex justify-between items-center">
                      <span className={`${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>Total Supply</span>
                      <span className={`font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                        1,000,000,000 CRY
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className={`${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>Initial Price</span>
                      <span className={`font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>$0.001</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className={`${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>Blockchain</span>
                      <span className={`font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>ICP</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className={`text-2xl font-bold mb-6 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                Token Distribution
              </h3>
              ...
              {[
                ...
                <div key={index} className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className={`${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>{item.label}</span>
                    <span className={`font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                      {item.percentage}%
                    </span>
                  </div>
                  <div className={`w-full h-3 rounded-full ${isDark ? "bg-[#181818]/50" : "bg-[#fffffe]/50"}`}>
                    <motion.div
      ...
      {/* Team Section */}
      <section id="team" className={`py-20 ${isDark ? "bg-[#181818]" : "bg-[#fffffe]"}`}>
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <Card
                  className={`${isDark ? "bg-[#181818] border-[#4fc4cf]/20" : "bg-[#fffffe] border-[#994ff3]/20"} hover:border-[#4fc4cf] transition-all duration-300 hover:transform hover:scale-105`}
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className={`text-sm ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>{member.bio}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <Card
                  className={`h-full ${isDark ? "bg-[#181818]/50 border-[#4fc4cf]/20" : "bg-[#fffffe]/50 border-[#994ff3]/20"} backdrop-blur-sm`}
                >
                  <CardContent className="p-6">
                    <Quote className={`h-8 w-8 mb-4 ${isDark ? "text-[#4fc4cf]" : "text-[#994ff3]"}`} />
                    <p className={`mb-6 ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>
                      "{testimonial.content}"
                    </p>
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className={`font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                          {testimonial.name}
                        </h4>
                        <p className={`text-sm ${isDark ? "text-[#fffffe]/60" : "text-[#181818]/60"}`}>
                          {testimonial.role}
                        </p>
                      </div>
                      <div className="flex">
      ...
      {/* FAQ Section */}
      <section id="faq" className={`py-20 ${isDark ? "bg-[#181818]" : "bg-[#fffffe]"}`}>
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-3xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="mb-4"
              >
                <Card className={`${isDark ? "bg-[#181818] border-[#4fc4cf]/20" : "bg-[#fffffe] border-[#994ff3]/20"}`}>
                  <CardContent className="p-0">
                    <button
                      onClick={() => toggleFaq(index)}
                      className="w-full p-6 text-left flex items-center justify-between hover:bg-opacity-50 transition-colors"
                    >
                      <h3 className={`text-lg font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                        {faq.question}
                      </h3>
                      {faqOpenStates[index] ? (
                        <Minus className={`h-5 w-5 ${isDark ? "text-[#4fc4cf]" : "text-[#994ff3]"}`} />
                      ) : (
                        <Plus className={`h-5 w-5 ${isDark ? "text-[#4fc4cf]" : "text-[#994ff3]"}`} />
                      )}
                    </button>
                    <AnimatePresence>
                      {faqOpenStates[index] && (
                        ...
                        >
                          <div className={`px-6 pb-6 ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>
                            {faq.answer}
                          </div>
                        </motion.div>
                      )}
      ...
      >
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className={`text-xl max-w-3xl mx-auto mb-12 ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>
              Connect with fellow creators, thinkers, and workers. Be part of the future of digital work.
            </p>

            <div className="flex flex-wrap justify-center gap-6 mb-12">
              {[
                { icon: <Discord className="h-6 w-6" />, label: "Discord", members: "10K+" },
                { icon: <Twitter className="h-6 w-6" />, label: "Twitter", members: "25K+" },
                { icon: <Telegram className="h-6 w-6" />, label: "Telegram", members: "8K+" },
                ...
                >
                  <Card
                    className={`${isDark ? "bg-[#181818]/50 border-[#4fc4cf]/20" : "bg-[#fffffe]/50 border-[#994ff3]/20"} hover:border-[#4fc4cf] transition-all duration-300 hover:transform hover:scale-105 cursor-pointer`}
                  >
                    <CardContent className="p-6 text-center">
                      ...
                      <h3 className={`font-bold mb-1 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
                        {social.label}
                      </h3>
                      <p className={`text-sm ${isDark ? "text-[#fffffe]/60" : "text-[#181818]/60"}`}>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className={`text-3xl font-bold ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>
      ...
      {/* Footer */}
      <footer
        className={`py-12 border-t ${isDark ? "bg-[#181818] border-[#4fc4cf]/20" : "bg-[#fffffe] border-[#994ff3]/20"}`}
      >
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className={`mb-6 max-w-md ${isDark ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}>
            ...
            <div>
              <h3 className={`font-bold mb-4 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>Platform</h3>
            ...
            <div>
              <h3 className={`font-bold mb-4 ${isDark ? "text-[#fffffe]" : "text-[#181818]"}`}>Resources</h3>
              <ul className="space-y-2">
          ...
          <div className={`mt-12 pt-8 border-t ${isDark ? "border-[#4fc4cf]/20" : "border-[#994ff3]/20"} text-center`}>
            <p className={`${isDark ? "text-[#fffffe]/60" : "text-[#181818]/60"}`}>
