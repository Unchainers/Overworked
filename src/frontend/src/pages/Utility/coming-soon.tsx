  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 pt-20">
        <div className="mx-auto max-w-6xl text-center">
          ...
          >
            ...
            <p
              className={`text-xl font-medium md:text-2xl ${theme === "dark" ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}
            >
          ...
          >
            <h2
              className={`mb-6 text-3xl font-bold md:text-5xl ${theme === "dark" ? "text-[#fffffe]" : "text-[#181818]"}`}
            >
            ...
            <p
              className={`mx-auto max-w-3xl text-lg md:text-xl ${theme === "dark" ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}
            >
          ...
          >
            <div className="mx-auto grid max-w-2xl grid-cols-2 gap-4 md:grid-cols-4">
              {[
                ...
                <Card
                  key={item.label}
                  className={`${theme === "dark" ? "border-[#4fc4cf]/20 bg-[#181818]/50" : "border-[#994ff3]/20 bg-[#fffffe]/50"} backdrop-blur-md`}
                >
          ...
          >
            <h3
              className={`mb-8 text-2xl font-bold ${theme === "dark" ? "text-[#fffffe]" : "text-[#181818]"}`}
            >
              What's Coming
            </h3>
            <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
              {[
                ...
                >
                  <Card
                    className={`h-full ${theme === "dark" ? "border-[#4fc4cf]/20 bg-[#181818]/30" : "border-[#994ff3]/20 bg-[#fffffe]/30"} backdrop-blur-md transition-colors hover:border-[#4fc4cf]`}
                  >
                    <CardContent className="p-6 text-center">
                      ...
                      <h4
                        className={`mb-2 text-lg font-bold ${theme === "dark" ? "text-[#fffffe]" : "text-[#181818]"}`}
                      >
                        {feature.title}
                      </h4>
                      <p
          ...
          >
            <Card
              className={`mx-auto max-w-md ${theme === "dark" ? "border-[#4fc4cf]/20 bg-[#181818]/50" : "border-[#994ff3]/20 bg-[#fffffe]/50"} backdrop-blur-md`}
            >
                ...
                {!isSubscribed ? (
                  <>
                    <div className="mb-4 flex items-center justify-center">
                      <Bell
                        className={`mr-2 h-6 w-6 ${theme === "dark" ? "text-[#4fc4cf]" : "text-[#994ff3]"}`}
                      />
                      <h3
                    ...
                    <p
                      className={`mb-4 text-sm ${theme === "dark" ? "text-[#fffffe]/80" : "text-[#181818]/80"}`}
                    >
                    ...
                    <form onSubmit={handleSubscribe} className="space-y-4">
                      <Input
                        ...
                        className={`${theme === "dark" ? "border-[#4fc4cf]/20 bg-[#181818]/50" : "border-[#994ff3]/20 bg-[#fffffe]/50"}`}
                        required
                      />
                      <Button
                        type="submit"
      ...
      >
        ...
        >
          <Calendar
            className={`h-4 w-4 ${theme === "dark" ? "text-[#4fc4cf]" : "text-[#994ff3]"}`}
          />
          <span
